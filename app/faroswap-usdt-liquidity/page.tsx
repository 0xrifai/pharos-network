...
export default function FaroswapUsdtLiquidityPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newTaskId = `faroswap-usdt-liquidity-${Date.now()}`
    setTaskId(newTaskId)

    try {
      const response = await fetch('/api/faroswap-usdt-liquidity', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Faroswap USDT Liquidity
          </h1>
          <p className="text-gray-600">
            Add USDT liquidity to Faroswap
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <LogsDisplay 
            taskId={taskId} 
            title="Faroswap USDT Liquidity Logs"
