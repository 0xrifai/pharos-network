...
export default function FaroswapUsdcSwapPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newTaskId = `faroswap-usdc-swap-${Date.now()}`
    setTaskId(newTaskId)

    try {
      const response = await fetch('/api/faroswap-usdc-swap', {
        method: 'POST',
        headers: {
