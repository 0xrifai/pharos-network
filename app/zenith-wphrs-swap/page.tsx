...
export default function ZenithWphrsSwapPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newTaskId = `zenith-wphrs-swap-${Date.now()}`
    setTaskId(newTaskId)

    try {
      const response = await fetch('/api/zenith-wphrs-swap', {
        method: 'POST',
        headers: {
