...
export default function ZenithUsdcSwapPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newTaskId = `zenith-usdc-swap-${Date.now()}`
    setTaskId(newTaskId)

    try {
      const response = await fetch('/api/zenith-usdc-swap', {
        method: 'POST',
        headers: {
