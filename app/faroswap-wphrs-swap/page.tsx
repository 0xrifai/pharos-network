...
export default function FaroswapWphrsSwapPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newTaskId = `faroswap-wphrs-swap-${Date.now()}`
    setTaskId(newTaskId)

    try {
      const response = await fetch('/api/faroswap-wphrs-swap', {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <LogsDisplay 
            taskId={taskId} 
            title="Faroswap WPHRS Swap Logs"
