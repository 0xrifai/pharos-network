...
export default function RwafiAquafluxPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newTaskId = `rwafi-aquaflux-${Date.now()}`
    setTaskId(newTaskId)

    try {
      const response = await fetch('/api/rwafi-aquaflux', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Rwafi Aquaflux Automation
          </h1>
          <p className="text-gray-600">
            Automate minting on Rwafi Aquaflux
          </p>
        </div>
